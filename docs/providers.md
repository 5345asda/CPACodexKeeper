...
示例 xAI 规则已在 [配置样例](reference/config.example.toml) 中提供：`access-denied-delete`、`chat-permission-denied-delete` 和精确匹配真实 CPA 错误的 `chat-endpoint-permission-denied-delete`。
